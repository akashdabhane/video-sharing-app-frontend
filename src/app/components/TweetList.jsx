...
function TweetList() {
    const tweets = [
        {
            id: 1,
            profilePicture: "https://images.pexels.com/photos/1115816/pexels-photo-1115816.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
            name: "React Patterns",
                        ...
                        <div class="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                            ...
                            <div class="w-full">
                                <h4 class="mb-1 flex items-center gap-x-2">
                                    ...
                                    <span class="inline-block text-sm text-gray-400">{item.createdAt} ago</span>
                                </h4>
                                <p class="mb-2">{item.tweet}</p>
