                            ...
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">22:18</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn the basics of building web applications with Node.js and Express.js framework.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">24:33</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        <h6 class="mb-1 font-semibold md:max-w-[75%]">Building a RESTful API with Node.js and Express</h6>
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to create a RESTful API using Node.js and the Express framework for building web applications.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">19:58</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Discover how to build mobile applications using React Native for both Android and iOS platforms.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">16:37</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to create and use custom hooks to share logic across multiple React components.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">32:18</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        <h6 class="mb-1 font-semibold md:max-w-[75%]">Building Scalable Web Applications with Django</h6>
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to build robust and scalable web applications using the Django framework for Python.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">29:30</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        <h6 class="mb-1 font-semibold md:max-w-[75%]">Creating Interactive UIs with React and D3</h6>
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to build dynamic and interactive user interfaces with React and the D3.js data visualization library.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">26:58</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        <h6 class="mb-1 font-semibold md:max-w-[75%]">Node.js Authentication with Passport.js</h6>
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to implement user authentication in Node.js applications using the Passport.js middleware.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">32:14</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to create stunning visualizations and dashboards using Tableau for data analysis.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">27:37</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        <h6 class="mb-1 font-semibold md:max-w-[75%]">Building Real-Time Applications with Socket.IO</h6>
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to create real-time applications using Socket.IO for seamless communication between clients and servers.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">31:55</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        <h6 class="mb-1 font-semibold md:max-w-[75%]">Advanced CSS: Animations and Transitions</h6>
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Learn how to create captivating animations and transitions using CSS for dynamic web experiences.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full max-w-3xl gap-x-4 md:flex">
                                <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
                                    <div class="w-full pt-[56%]">
                                        ...
                                        <span class="absolute bottom-1 right-1 inline-block rounded bg-black px-1.5 text-sm">30:25</span>
                                    </div>
                                </div>
                                <div class="flex gap-x-2 md:w-7/12">
                                    <div class="h-10 w-10 shrink-0 md:hidden">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="mt-2 hidden text-sm md:block">Explore advanced patterns and techniques for building scalable and maintainable React applications.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
